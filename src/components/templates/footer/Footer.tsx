  ...
  return (
    <footer className="bg-neutral-600 w-full">
      <div className="mx-auto w-full max-w-[75rem]">
        ...
        <div className="px-4 py-6 bg-neutral-500 md:flex md:items-center md:justify-between">
          <span className="text-sm text-gray-500 dark:text-gray-300 sm:text-center">
            © 2024 <a href="https://flowbite.com/">Factura Pro</a>. Todos los derechos reservados
          </span>
